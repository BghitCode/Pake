...
> This guide shows how to use BghitApp as a GitHub Action in your own projects. For using our project's built-in GitHub Actions workflow, see [GitHub Actions Usage](github-actions-usage.md).

## Quick Start

```yaml
- name: Build BghitApp App
  uses: BghitCode/BghitApp@v3
  with:
...
1. **Auto Setup**: Installs Rust, Node.js dependencies, builds BghitApp CLI
2. **Build App**: Runs `bghitapp` command with your parameters
...
- [GitHub Actions Usage](github-actions-usage.md) - Using BghitApp's built-in workflow
